...
var FullCalendar = (function (e) {
        ...
        return 1 === o && "short" === e.timeZoneName
            ...
            : 0 === o && t.week
                ...
                : (function (e, t, n) {
                    ...
                    return function (r) {
                        var a = r.marker,
                            s = (o && !a.getUTCMinutes() ? o : i).format(a);
    ...
    function On(e, t, n, o, i) {
        ...
        return (
            ...
            (u.range.end = Pn(t.allDay, u.range.start, i)),
                u
        );
    }
                ...
                (e.prototype.getCurrentData = function () {
                    ...
                    (e.prototype.today = function () {
                        ...
                        this.unselect(),
                            this.dispatch({
                                type: "CHANGE_DATE",
                                dateMarker: Vn(e.calendarOptions.now, e.dateEnv),
                            });
                    }),
    ...
    function wr(e, t, n) {
        void 0 === t && (t = !1);
        var r = n ? e.getBoundingClientRect() : Rr(e),
            o = Cr(e, t),
            i = {
    ...
    var Hr = FullCalendarVDom.Component,
        Or = FullCalendarVDom.createElement,
        Ar = FullCalendarVDom.render,
        Ur = FullCalendarVDom.createRef,
        Lr = FullCalendarVDom.Fragment,
        Wr = FullCalendarVDom.createContext,
        Vr = FullCalendarVDom.flushToDom,
    ...
    var Gr = (function (e) {
        ...
        return (
            n(t, e),
                ...
                (t.addPropsEquality = Yr),
                (t.addStateEquality = Zr),
                (t.contextType = Br),
                t
        );
    })(Hr);
        ...
        return (
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        var y = u[m],
                            ...
                            S = c[y.defId],
                            D = l[y.defId];
                        if (!no(S.constraints, E, d, e.businessHours, t))
                            return !1;
                        ...
                        for (
                            var k = i.eventStore, M = 0, x = S.allows;
                            M < x.length;
                            M++
                        ) {
                            var _ = x[M],
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    o && (c = o(c));
                    if (!no(c.constraints, u, i, e.businessHours, t))
                        return !1;
            ...
            n(t, e),
                ...
                (t.prototype.isDateSelectionValid = function (e) {
                    ...
                    return (
                        ...
                        ((t = e), (n = this.context), eo({dateSelection: t}, n))
                    );
                }),
                ...
                return (
                    (t.rootElRef = Ur()),
                        (t.handleRootEl = function (e) {
                            Xr(t.rootElRef, e),
                            t.props.elRef && Xr(t.props.elRef, e);
                        }),
                        t
                );
            }
                ...
                n(t, e),
                    ...
                    (t.prototype.renderInnerContent = function () {
                        var e = this.context.pluginHooks.contentTypeHandlers,
                            ...
                            o = yo(t.content, t.hookProps),
                            i = null;
                        if (
                            (void 0 === o &&
                            (o = yo(t.defaultContent, t.hookProps)),
                            void 0 !== o)
                        ) {
    ...
    var wo = (function () {
        function e(e) {
            (this.props = e),
                (this.nowDate = Vn(e.nowInput, e.dateEnv)),
                this.initHiddenDays();
        }
        ...
        return (
            (e.prototype.buildPrev = function (e, t, n) {
                ...
                o = i.subtract(
                    i.startOf(t, e.currentRangeUnit),
                    e.dateIncrement
                );
                return this.build(o, -1, n);
            }),
                ...
                (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                    ...
                    function d() {
                        if ("month" == u) {
                            ...
                            r.month(r.month() + 1);
                            var s = t.toDate();
                            (s = we(s)).getDate() < t.toDate().getDate()
                                ? s.setDate(s.getDate() + 1)
                                : s.getDate() > t.toDate().getDate() &&
                                s.setDate(s.getDate() - 1),
                                (t = new persianDate(s));
                            var c = r.toDate();
                            (c = we(c)).getDate() < r.toDate().getDate()
                                ? c.setDate(c.getDate() - 1)
                                : c.getDate() > r.toDate().getDate() &&
                                c.setDate(c.getDate() + 1),
                                (r = new persianDate(c)),
                                (a = {start: t.toDate(), end: r.toDate()}),
                                console.log(e, {
                                    start: t.toDate(),
                                    end: r.toDate(),
                                });
    ...
    function Lo(e, t, n, r, o) {
        ...
        return {
            headerToolbar: e.headerToolbar
                ? Wo(e.headerToolbar, e, t, n, r, o, i)
                : null,
            footerToolbar: e.footerToolbar
                ? Wo(e.footerToolbar, e, t, n, r, o, i)
                : null,
            viewsWithButtons: i,
        };
    }
        ...
        Yo = (function () {
            function e(e, t) {
                (this.runTaskOption = e),
                    ...
                    (this.queue = []),
                    (this.delayedRunner = new qo(this.drain.bind(this)));
            }
    ...
    var Xo = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = st(this._computeOptionsData)),
                ...
                (this.organizeRawLocales = st(Qn)),
                (this.buildLocale = st(er)),
                                        ...
                                        for (
                                            ...
                                            ((n[s.id] = !0),
                                                ...
                                                (o = {
                                                    ...
                                                    isLoadingFuncs:
                                                        l.isLoadingFuncs.concat(
                                                            u.isLoadingFuncs
                                                        ),
                                                    contextInit:
                                                        l.contextInit.concat(
                                                            u.contextInit
                                                        ),
                                                    eventRefiners: r(
                                                        r({}, l.eventRefiners),
                ...
                (this.buildDateEnv = st(Ko)),
                (this.buildTheme = st(Jo)),
                (this.parseToolbars = st(Lo)),
                (this.buildViewSpecs = st(bo)),
                (this.buildDateProfileGenerator = lt($o)),
                (this.buildViewApi = st(Qo)),
                (this.buildViewUiProps = lt(ni)),
                (this.buildEventUiBySource = st(ei, Ve)),
                (this.buildEventUiBases = st(ti)),
                (this.parseContextBusinessHours = lt(oi)),
                (this.buildTitle = st(Zo)),
                (this.emitter = new Mr()),
                (this.actionRunner = new Yo(
            ...
            for (
                var y = Ro(s.calendarOptions, h, v),
                    E = {
                        ...
                        eventResize: null,
                        selectionConfig:
                        this.buildViewUiProps(v).selectionConfig,
                    },
                    S = r(r({}, v), E),
                    D = 0,
                    b = s.pluginHooks.reducers;
                D < b.length;
                D++
            ) {
                var C = b[D];
            ...
            ri(E, v) && this.emitter.trigger("loading", !0),
                (this.state = E),
                this.updateData(),
        ...
        return (
            (e.prototype.resetOptions = function (e, t) {
                ...
                (e.prototype._handleAction = function (e) {
                    ...
                    for (
                        var p = To(n.eventSources, e, d, u),
                            f = Kr(n.eventStore, e, p, d, u),
                            h =
                                (ko(p) &&
                ...
                (e.prototype.processRawCalendarOptions = function (e, t) {
                    var n = _t([wt, e, t]),
                        ...
                        u = this.buildPluginHooks(e.plugins || [], Bo),
    ...
    var ci = {},
        ...
        pi = {},
        fi = {startTime: Xe, duration: Xe, create: Boolean, sourceId: String};
    ...
    var vi = (function (e) {
        ...
        Si = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.buildViewContext = st(jr)),
                        (t.buildViewPropTransformers = st(bi)),
                        (t.buildToolbarProps = st(Di)),
    ...
    var ki = (function (e) {
                ...
                n(t, e),
                    (t.prototype.render = function () {
                        var e = this.props,
                            ...
                            u = [Ri].concat(gr(l, o), e.extraClassNames || []),
        ...
        xi = (function (e) {
            function t(t, n) {
                ...
                return (
                    (r.initialNowDate = Vn(n.options.now, n.dateEnv)),
        ...
        function t() {
            ...
            return (
                (t.processCols = st(function (e) {
                    ...
                    (t.renderMicroColGroup = st(Gi)),
                    (t.scrollerRefs = new Wi()),
                    (t.scrollerElRefs = new Wi(t._handleScrollerEl.bind(t))),
                    (t.state = {
                        shrinkWidth: null,
                        forceYScrollbars: !1,
            ...
            n(t, e),
                (t.prototype.render = function () {
                    ...
                    return Or(
                        ...
                        Boolean(!h && d.length) &&
                        Or.apply(void 0, o(["thead", {}], d)),
                        Boolean(!h && p.length) &&
                        Or.apply(void 0, o(["tbody", {}], p)),
                        Boolean(!h && f.length) &&
                        Or.apply(void 0, o(["tfoot", {}], f)),
                        h && Or.apply(void 0, o(["tbody", {}], d, p, f))
                    );
                }),
                (t.prototype.renderSection = function (e, t) {
                    return "outerContent" in e
                        ? Or(Lr, {key: e.key}, e.outerContent)
                        : Or(
                            "tr",
                            {
                                key: e.key,
                ...
                (t.prototype.computeShrinkWidth = function () {
                    return Yi(this.props.cols)
                        ? Vi(this.scrollerElRefs.getAll())
                        : 0;
                }),
    ...
    function na(e) {
        return Or(
            ...
            e.timeText && Or("div", {className: "fc-event-time"}, e.timeText),
            Or(
                "div",
    ...
    function aa(e) {
        var t = e.date,
            n = e.dateEnv,
            o = vr(t, e.todayRange, null, e.dateProfile);
        return r(
            r(r({date: n.toDate(t), view: e.viewApi}, o), {
                dayNumberText: e.showDayNumber ? n.format(t, oa) : "",
            }),
            e.extraProps
        );
    }
    ...
    var sa = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = lt(aa)), (t.normalizeClassNames = go()), t
            );
        }
    ...
    function ca(e) {
        return (
            e.event.title &&
            Or("div", {className: "fc-event-title"}, e.event.title)
        );
    }
        ...
        function t(t, n) {
            ...
            return (
                (o.isRendering = !1),
                    ...
                    (o.el = t),
                    (o.renderRunner = new qo(o.handleRenderRequest)),
                    new Xo({
                        optionOverrides: n,
                        calendarApi: o,
    ...
    var ha = 0,
        ...
        ma = (function () {
            function e(e) {
                ...
                1 === (va += 1) &&
                window.addEventListener("touchmove", ya, {
                    passive: !1,
                });
            }
    ...
    var Ea = (function () {
        ...
        Ca = "function" == typeof performance ? performance.now : Date.now,
        wa = (function () {
            function e() {
                var e = this;
                (this.isEnabled = !0),
        ...
        Ta = (function () {
            function e(e) {
                (this.origRect = Rr(e)),
                    (this.scrollCaches = Tr(e).map(function (e) {
                        return new Da(e, !0);
                    }));
            }
            ...
            function t(t) {
                ...
                (n.dragSelection = null),
                    ...
                    (n.handlePointerUp = function (e) {
                        n.dragSelection &&
                        (_n(n.dragSelection, e, n.component.context),
                            (n.dragSelection = null));
                    });
                var o = t.component.context.options,
                    i = (n.dragging = new Ra(t.el));
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleHitUpdate = function (e, t, o) {
                    ...
                    u &&
                    ((c = Nn(a, i.getCurrentData().eventUiBases, u, i)),
                        (p.mutatedEvents = c),
                ...
                (this.context = e),
                    ...
                    (this.onDocumentPointerDown = function (e) {
                        ...
                        (t.matchesCancel = !!z(r, n)),
                            (t.matchesEvent = !!z(r, Pa.SELECTOR));
                    }),
            ...
            return (
                (e.prototype.buildDragMeta = function (e) {
                    return "object" == typeof this.suppliedDragMeta
                        ? hi(this.suppliedDragMeta)
                        : "function" == typeof this.suppliedDragMeta
                            ? hi(this.suppliedDragMeta(e))
                            : hi(
                                (t = (function (e, t) {
                                    var n = pi.dataAttrPrefix,
                                        r = (n ? n + "-" : "") + t;
            ...
            return (
                n(t, e),
                    ...
                    (t.prototype.renderHScrollLayout = function (e, t, n, r) {
                        ...
                        var i = this.props,
                            a = this.context,
                            s = !i.forPrint && Ji(a.options),
                            l = !i.forPrint && $i(a.options),
                            u = [];
                        return (
                            e &&
                            u.push({
                ...
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context.options.navLinks
                            ? {"data-navlink": mr(e.date), tabIndex: 0}
                            : {};
                    return Or(
                        ia,
                        {
                ...
                n(t, e),
                    (t.prototype.render = function () {
                        var e = this,
                            ...
                            u = n.navLinks
                                ? {"data-navlink": mr(a, "week"), tabIndex: 0}
                                : {};
                        return Or(
                            sa,
                            {
        ...
        return (
            n(t, e),
                (t.prototype.render = function () {
                    var e = this.props,
                        t = this.context,
                        n = t.options.eventTimeFormat || Ja,
    ...
    var is = (function (e) {
        function t() {
            ...
            return (
                (t.cellElRefs = new Wi()),
                    (t.frameElRefs = new Wi()),
                    (t.fgElRefs = new Wi()),
                    (t.segHarnessRefs = new Wi()),
                    (t.rootElRef = Ur()),
                    (t.state = {
                        framePositions: null,
            ...
            n(t, e),
                (t.prototype.render = function () {
                    var e = this,
                        ...
                        o = this.context,
                        i = t.cells.length,
                        a = ja(t.businessHourSegs, i),
                        s = ja(t.bgEventSegs, i),
                        l = ja(this.getHighlightSegs(), i),
    ...
    is.addPropsEquality({onMoreClick: !0}),
        is.addStateEquality({segHeights: Ve});
    var as = 10,
        ss = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.repositioner = new qo(t.updateSize.bind(t))),
                        (t.handleRootEl = function (e) {
                            (t.rootEl = e), t.props.elRef && Xr(t.props.elRef, e);
                        }),
        ...
        us = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.splitBusinessHourSegs = st(Ba)),
                        (t.splitBgEventSegs = st(Ba)),
                        (t.splitFgEventSegs = st(Ba)),
                        (t.splitDateSelectionSegs = st(Ba)),
                        (t.splitEventDrag = st(Ga)),
                        (t.splitEventResize = st(Ga)),
                        (t.buildBuildMoreLinkText = st(cs)),
                        (t.morePopoverRef = Ur()),
                        (t.rowRefs = new Wi()),
            ...
            return (
                n(t, e),
                    ...
                    (t.prototype.renderHScrollLayout = function (
                        ...
                        var u = this.context,
                            c = this.props,
                            d = !c.forPrint && Ji(u.options),
                            p = !c.forPrint && $i(u.options),
                            f = [];
                        e &&
                        f.push({
                            type: "header",
    ...
    function Ns(e) {
        ...
        if (null == e.forwardPressure) {
            for (t = 0; t < r.length; t += 1)
                Ns((n = r[t])), (o = Math.max(o, 1 + n.forwardPressure));
            e.forwardPressure = o;
        }
    }
    ...
    var As = bt({hour: "numeric", minute: "2-digit", meridiem: !1}),
        Us = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
    ...
    var Ws = (function (e) {
                                    ...
                                    r(
                                        {
                                            ...
                                            isCondensed:
                                                e.bottom - e.top <
                                                pi.timeGridEventCondensedHeight,
                                        },
        ...
        Vs = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
                return (
                    (t.splitFgEventSegs = st(Ms)),
                        (t.splitBgEventSegs = st(Ms)),
                        (t.splitBusinessHourSegs = st(Ms)),
                        (t.splitNowIndicatorSegs = st(Ms)),
                        (t.splitDateSelectionSegs = st(Ms)),
                        (t.splitEventDrag = st(xs)),
                        (t.splitEventResize = st(xs)),
                        (t.rootElRef = Ur()),
                        (t.cellElRefs = new Wi()),
                        t
                );
    ...
    var Zs = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = st(Xs)), (t.buildSlatMetas = st(Ys)), t
            );
        }
    ...
    function $s(e) {
        ...
        return Or(
            Lr,
            null,
            e.text && Or("a", r({className: "fc-list-day-text"}, t), e.text),
            e.sideText &&
            Or(
                "a",
    ...
    var Qs = bt({hour: "numeric", minute: "2-digit", meridiem: "short"}),
        el = (function (e) {
            function t() {
                return (null !== e && e.apply(this, arguments)) || this;
            }
                ...
                n(t, e),
                    (t.prototype.render = function () {
                        var e = this.props,
                            t = this.context,
                            n = e.seg,
                            r = t.options.eventTimeFormat || Qs;
                        return Or(
                            ea,
                            {
                                seg: n,
                    ...
                    return Or(xi, {unit: "day"}, function (e, n) {
                        for (var s = [], l = 0; l < a.length; l += 1) {
                            ...
                            if (u) {
                                ...
                                s.push(
                                    Or(Js, {key: c, dayDate: t[l], todayRange: n})
                                );
                                for (
    ...
    (ll.prototype.classes = {
        ...
        (ll.prototype.baseIconClass = "fa"),
        (ll.prototype.iconClasses = {
            close: "fa-times",
        ...
        (ll.prototype.iconOverrideOption = "bootstrapFontAwesome"),
        (ll.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome"),
        (ll.prototype.iconOverridePrefix = "fa-");
    var ul = so({themeClasses: {bootstrap: ll}}),
        cl = {googleCalendarApiKey: String},
        dl = {
    ...
    var fl = so({
        ...
        optionRefiners: cl,
        eventSourceRefiners: dl,
    });
    return (
        Bo.push(Fa, gs, Ks, sl, ul, fl),
            ...
            (e.Calendar = fa),
            (e.CalendarApi = Fn),
            (e.CalendarContent = Si),
            (e.CalendarDataManager = Xo),
            (e.CalendarDataProvider = ai),
            (e.CalendarRoot = Ci),
            (e.Component = Hr),
            (e.ContentHook = fo),
            (e.CustomContentRenderContext = po),
            (e.DateComponent = ao),
            (e.DateEnv = Kn),
            (e.DateProfileGenerator = wo),
            (e.DayCellContent = ia),
            (e.DayCellRoot = sa),
            (e.DayGridView = hs),
            (e.DayHeader = Ii),
            ...
            (e.DayTableSlicer = ps),
            (e.DayTimeCols = js),
            (e.DayTimeColsSlicer = Bs),
            (e.DayTimeColsView = Zs),
            (e.DelayedRunner = qo),
            (e.Draggable = La),
            (e.ElementDragging = di),
            (e.ElementScrollController = Ir),
            (e.Emitter = Mr),
            (e.EventApi = zn),
            (e.EventRoot = ea),
            (e.EventSourceApi = V),
            (e.FeaturefulElementDragging = Ra),
            (e.Fragment = Lr),
            (e.Interaction = li),
            (e.ListView = rl),
            (e.MountHook = vo),
            (e.NamedTimeZoneImpl = si),
            (e.NowIndicatorRoot = ra),
            (e.NowTimer = xi),
            (e.PointerDragging = ma),
            (e.PositionCache = xr),
            (e.RefMap = Wi),
            (e.RenderHook = co),
            (e.ScrollController = _r),
            (e.ScrollResponder = zr),
            (e.Scroller = Li),
            (e.SimpleScrollGrid = Qi),
            (e.Slicer = Oi),
            (e.Splitter = fr),
            (e.StandardEvent = ta),
            (e.Table = us),
            ...
            (e.TableView = za),
            (e.Theme = Nr),
            (e.ThirdPartyDraggable = Va),
            (e.TimeCols = Fs),
            (e.TimeColsSlatsCoords = Rs),
            (e.TimeColsView = Cs),
            (e.ViewApi = An),
            (e.ViewContextType = Br),
            (e.ViewRoot = Eo),
            (e.WeekNumberRoot = da),
            (e.WindowScrollController = Pr),
            (e.addDays = me),
            (e.addDurations = Je),
            (e.addMs = ye),
            (e.addWeeks = ge),
            ...
            (e.allowSelection = oe),
            (e.applyMutationToEventStore = Nn),
            (e.applyStyle = q),
            (e.applyStyleProp = Y),
            ...
            (e.buildClassNameNormalizer = go),
            (e.buildDayRanges = Gs),
            (e.buildDayTableModel = vs),
            (e.buildEventApis = jn),
            ...
            (e.buildNavLinkData = mr),
            (e.buildSegCompareObj = mn),
            (e.buildSegTimeText = Dn),
            (e.buildSlatMetas = Ys),
            (e.buildTimeColsModel = Xs),
        ...
        (e.getCanVGrowWithinCell = dr),
        (e.getClippingParents = Tr),
        (e.getDateMeta = vr),
        (e.getDayClassNames = gr),
        (e.getDefaultEventEnd = Pn),
        (e.getElSeg = fn),
        (e.getEventClassNames = Cn),
        (e.getIsRtlScrollbarOnLeft = Sr),
        (e.getRectCenter = ur),
        (e.getRelevantEvents = Ot),
        (e.getScrollGridClassNames = Zi),
        (e.getScrollbarWidths = Dr),
        (e.getSectionClassNames = Xi),
        (e.getSectionHasLiquidHeight = Fi),
        (e.getSegMeta = bn),
        ...
        (e.getStickyFooterScrollbar = $i),
        (e.getStickyHeaderDates = Ji),
        ...
        (e.hasShrinkWidth = Yi),
        (e.identity = Pt),
        (e.interactionSettingsStore = ci),
        (e.interactionSettingsToStore = ui),
        (e.intersectRanges = on),
        (e.intersectRects = sr),
        (e.isArraysEqual = at),
        (e.isColPropsEqual = ji),
        (e.isDateSpansEqual = kn),
        (e.isInt = fe),
        (e.isInteractionValid = Qr),
        ...
        (e.padStart = de),
        (e.parseBusinessHours = ir),
        (e.parseClassNames = Wt),
        (e.parseDragMeta = hi),
        (e.parseEventDef = Jt),
        (e.parseFieldSpecs = se),
        (e.parseMarker = Xn),
        (e.pointInsideRect = ar),
        ...
        (e.render = Ar),
        (e.renderChunkContent = Bi),
        (e.renderFill = la),
        (e.renderMicroColGroup = Gi),
        (e.renderScrollShim = Ki),
        (e.requestJson = Vo),
        (e.sanitizeShrinkWidth = qi),
        (e.setElSeg = pn),
        (e.setRef = Xr),
