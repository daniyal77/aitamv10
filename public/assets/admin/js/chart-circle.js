    ...
    1: function (e, t, n) {
        ...
        !function (t, n) {
            ...
            var o = [], a = Object.getPrototypeOf, s = o.slice, u = o.flat ? function (e) {
                ...
                g = h.call(Object), v = {}, m = function (e) {
            ...
            var E = function (e) {
                var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, m, y, x, b = "sizzle" + 1 * new Date,
                    w = e.document, T = 0, C = 0, S = ue(), E = ue(), k = ue(), A = ue(), j = function (e, t) {
                        return e === t && (f = !0), 0
                    }, N = {}.hasOwnProperty, D = [], q = D.pop, L = D.push, P = D.push, O = D.slice, H = function (e, t) {
                    ...
                    B = new RegExp(R + "+", "g"),
                    $ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$", "g"),
                    _ = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"),
                    V = new RegExp(R + "|>"), U = new RegExp(W), X = new RegExp("^" + I + "$"), G = {
                        ID: new RegExp("^#(" + I + ")"),
                        CLASS: new RegExp("^\\.(" + I + ")"),
                        TAG: new RegExp("^(" + I + "|[*])"),
                        ATTR: new RegExp("^" + F),
                        ...
                        (s = k(e, function (e, t) {
                            var n = t.length > 0, i = e.length > 0, o = function (o, a, s, u, c) {
                                var f, h, v, m = 0, y = "0", x = o && [], b = [], w = l,
                                    C = o || i && r.find.TAG("*", c), S = T += null == w ? 1 : Math.random() || .1,
                                    E = C.length;
            ...
            var O = /^(?:parents|prev(?:Until|All))/, H = {children: !0, contents: !0, next: !0, prev: !0};
                                    ...
                                    return function () {
                                        var s = this, u = arguments, l = function () {
                                            ...
                                            if (!(e < o)) {
                                                ...
                                                l = n && ("object" == typeof n || "function" == typeof n) && n.then, m(l) ? i ? l.call(n, a(o, t, I, i), a(o, t, F, i)) : (o++, l.call(n, a(o, t, I, i), a(o, t, F, i), a(o, t, I, t.notifyWith))) : (r !== I && (s = void 0, u = [n]), (i || t.resolveWith)(s, u))
                                            }
                                        }, c = i ? l : function () {
                                            try {
                                                l()
            ...
            var z = function (e, t, n, r, i, o, a) {
                ...
                if ("object" === T(n)) for (s in i = !0, n) z(e, t, s, n[s], !0, o, a); else if (void 0 !== r && (i = !0, m(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) {
                    return l.call(C(e), n)
            ...
            var Ce = /^key/, Se = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ee = /^([^.]*)(?:\.(.+)|)/;
            ...
            function Fe(e, t, n, r) {
                ...
                if (p && (o = (i = Te(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                    ...
                    if (s) for (c = a[a.length - 1].ownerDocument, C.map(a, Me), f = 0; f < s; f++) l = a[f], me.test(l.type || "") && !J.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : w(l.textContent.replace(Pe, ""), l, c))
                }
                return e
            }
            ...
            var Xe = ["Webkit", "Moz", "ms"], Ge = x.createElement("div").style, Ye = {};
            ...
            function rt(e, t, n) {
                var r = $e(e), i = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r),
            ...
            C.extend({
                ...
                css: function (e, t, n, r) {
                    var i, o, a, s = G(t);
                    return Ke.test(t) || (t = Qe(s)), (a = C.cssHooks[t] || C.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ve(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                }
            ...
            function dt(e, t, n) {
                ...
                }(c, l.opts.specialEasing); o < a; o++) if (r = dt.prefilters[o].call(l, e, c, l.opts)) return m(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
            ...
            var St = n.location, Et = {guid: Date.now()}, kt = /\?/;
            ...
            var Lt = /%20/g, Pt = /#.*$/, Ot = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm,
                Mt = /^(?:GET|HEAD)$/, Rt = /^\/\//, It = {}, Ft = {}, Wt = "*/".concat("*"), Bt = x.createElement("a");
            ...
            Bt.href = St.href, C.extend({
                ...
                ajax: function (e, t) {
                    ...
                    var r, i, o, a, s, u, l, c, f, p, d = C.ajaxSetup({}, t), h = d.context || d,
                        ...
                        m = C.Callbacks("once memory"), y = d.statusCode || {}, b = {}, w = {}, T = "canceled", S = {
                    ...
                    for (f in (c = C.event && d.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Mt.test(d.type), i = d.url.replace(Pt, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Lt, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (kt.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(Ot, "$1"), p = (kt.test(i) ? "&" : "?") + "_=" + Et.guid++ + p), d.url = i + p), d.ifModified && (C.lastModified[i] && S.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && S.setRequestHeader("If-None-Match", C.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && S.setRequestHeader("Content-Type", d.contentType), S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : d.accepts["*"]), d.headers) S.setRequestHeader(f, d.headers[f]);
                    ...
                    function E(e, t, a, u) {
                        ...
                        }(d, S, a)), !f && C.inArray("script", d.dataTypes) > -1 && (d.converters["text script"] = function () {
                        }), b = function (e, t, n, r) {
            ...
            C.ajaxSetup({
                ...
                if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Yt, "$1" + i) : !1 !== e.jsonp && (e.url += (kt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
        ...
        !function (e) {
            ...
            o.circleProgress((t = {
                ...
                fill: {color: "#6259ca"}
            }, i = "round", (r = "lineCap") in t ? Object.defineProperty(t, r, {
                value: i,
                enumerable: !0,
                configurable: !0,
                writable: !0
            }) : t[r] = i, t)), setTimeout((function () {
                o.circleProgress("value", .7)
            }), 1e3), setTimeout((function () {
                o.circleProgress("value", 1)
            }), 1100), setTimeout((function () {
                o.circleProgress("value", .5)
            }), 2100)
        }(jQuery)
    }, 34: function (e, t, n) {
        var r, i, o;
        i = [n(1)], void 0 === (o = "function" == typeof (r = function (e) {
            ...
            t.prototype = {
                ...
                initFill: function () {
                    var t, n = this, r = this.fill, i = this.ctx, o = this.size;
                    ...
                    if ("string" == typeof r && (r = {color: r}), r.color && (this.arcFill = r.color), r.gradient) {
                        ...
                        if (1 == a.length) this.arcFill = a[0]; else if (a.length > 1) {
                            for (var s = r.gradientAngle || 0, u = r.gradientDirection || [o / 2 * (1 - Math.cos(s)), o / 2 * (1 + Math.sin(s)), o / 2 * (1 + Math.cos(s)), o / 2 * (1 - Math.sin(s))], l = i.createLinearGradient.apply(i, u), c = 0; c < a.length; c++) {
                                var f = a[c], p = c / (a.length - 1);
                ...
                drawArc: function (e) {
                    if (0 !== e) {
                        var t = this.ctx, n = this.radius, r = this.getThickness(), i = this.startAngle;
                        t.save(), t.beginPath(), this.reverse ? t.arc(n, n, n - r / 2, i - 2 * Math.PI * e, i) : t.arc(n, n, n - r / 2, i, i + 2 * Math.PI * e), t.lineWidth = r, t.lineCap = this.lineCap, t.strokeStyle = this.arcFill, t.stroke(), t.restore()
                    }
                },
                drawEmptyArc: function (e) {
                    var t = this.ctx, n = this.radius, r = this.getThickness(), i = this.startAngle;
                    e < 1 && (t.save(), t.beginPath(), e <= 0 ? t.arc(n, n, n - r / 2, 0, 2 * Math.PI) : this.reverse ? t.arc(n, n, n - r / 2, i, i - 2 * Math.PI * e) : t.arc(n, n, n - r / 2, i + 2 * Math.PI * e, i), t.lineWidth = r, t.strokeStyle = this.emptyFill, t.stroke(), t.restore())
                },
                drawAnimated: function (t) {
                    var n = this, r = this.el, i = e(this.canvas);
                    i.stop(!0, !1), r.trigger("circle-animation-start"), i.css({animationProgress: 0}).animate({animationProgress: 1}, e.extend({}, this.animation, {
                        step: function (e) {
            ...
            }, e.circleProgress = {defaults: t.prototype}, e.easing.circleProgressEasing = function (e) {
                return e < .5 ? .5 * (e *= 2) * e * e : 1 - .5 * (e = 2 - 2 * e) * e * e
            }, e.fn.circleProgress = function (n, r) {
                var i = "circle-progress", o = this.data(i);
                if ("widget" == n) {
                ...
                return this.each((function () {
                    var r = e(this), o = r.data(i), a = e.isPlainObject(n) ? n : {};
                    if (o) o.init(a); else {
